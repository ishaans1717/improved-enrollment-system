...
public class DataLoader {
    ...
    CommandLineRunner loadDefaultCourses(CourseRepository courseRepository) {
        return args -> {
            ...
            //load 18 courses
            courseRepository.save(createCourse("168", "Structured Problem Solving Using The Computer", 4,
                    "Introduction to problem solving and programming fundamentals using computers", 30));

            courseRepository.save(createCourse("170", "Scripting Languages and Automation", 3,
                    "Learn scripting languages for automation tasks and workflow optimization", 30));

            courseRepository.save(createCourse("178", "Computer Application Programming", 3,
                    "Fundamental concepts of computer application programming and software development", 30));

            courseRepository.save(createCourse("179", "Introduction To Data Structures", 3,
                    "Basic data structures including arrays, lists, stacks, queues and their applications", 30));

            courseRepository.save(createCourse("180", "C++ Programming", 1,
                    "Introduction to C++ programming language syntax and object-oriented concepts", 25));

            courseRepository.save(createCourse("191", "Introduction To IT Professional Practice", 1,
                    "Professional practices, ethics, and career development in the IT field", 25));

            courseRepository.save(createCourse("214", "Social, Legal, And Ethical Issues In Information Technology", 3,
                    "Ethics, legal considerations, and social impact of information technology", 30));

            courseRepository.save(createCourse("215", "Introduction to Applied Artificial Intelligence", 3,
                    "Fundamentals of AI, machine learning algorithms and practical applications", 30));

            courseRepository.save(createCourse("225", "Computer Organization", 3,
                    "Architecture and organization of computer systems and hardware components", 30));

            courseRepository.save(createCourse("244", "Business Analytics for Artificial Intelligence", 3,
                    "Apply AI and machine learning techniques to business analytics and decision making", 30));

            courseRepository.save(createCourse("250", "Fundamentals of Information Assurance and Security", 3,
                    "Security principles, risk management, and cybersecurity best practices", 30));

            courseRepository.save(createCourse("254", "Hardware And Software Concepts", 3,
                    "Understanding hardware and software interactions, system architecture and integration", 30));

            courseRepository.save(createCourse("261", "Systems Development I", 3,
                    "Software development lifecycle, methodologies, and project planning techniques", 30));

            courseRepository.save(createCourse("262", "Information Technology Project Management", 3,
                    "Project management principles, tools, and methodologies for IT projects", 30));

            courseRepository.save(createCourse("272", "Cobol As A Second Language", 4,
                    "COBOL programming for business applications and legacy system maintenance", 25));

            courseRepository.save(createCourse("275", "Java As A Second Language", 4,
                    "Java programming fundamentals, object-oriented design, and application development", 30));

            courseRepository.save(createCourse("276", "Data Communications", 3,
                    "Principles of data transmission, networking protocols, and communication systems", 30));

            courseRepository.save(createCourse("279", "Algorithms And Data Structures", 3,
    ...
    private Course createCourse(String code, String title, int credits, String description, int capacity) {
